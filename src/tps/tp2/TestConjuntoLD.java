...
class TestConjuntoLD {
	public static void main(String [] args) {
		ConjuntoTDA conjunto_a = new ConjuntoLD();
		ConjuntoTDA conjunto_b = new ConjuntoLD();
		ConjuntoTDA conjunto_c = new ConjuntoLD();
		...
		System.out.println("### TEST: Conjunto Listas Dinamicas ###");
		// Punto 3
