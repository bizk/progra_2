...
import implementaciones.arreglos.ConjuntoUA;
import utilidades.Metodos;

import java.util.Scanner;

class TestConjuntoUA {
	public static void main(String [] args) {
		ConjuntoTDA conjunto_a = new ConjuntoUA();
		ConjuntoTDA conjunto_b = new ConjuntoUA();
		ConjuntoTDA conjunto_c = new ConjuntoUA();
		...
		System.out.println("### TEST: Conjunto UA###");
		// Punto 3
